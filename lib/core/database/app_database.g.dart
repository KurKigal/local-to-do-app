...
class $RecurrencesTable extends Recurrences
  ...
  frequency = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
  ).withConverter<RecurrenceFrequency>($RecurrencesTable.$converterfrequency);
  ...
  static const VerificationMeta _occurrenceNumberMeta = const VerificationMeta(
    'occurrenceNumber',
  );
  @override
  late final GeneratedColumn<int> occurrenceNumber = GeneratedColumn<int>(
    'occurrence_number',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _nextOccurrenceTaskIdMeta =
      const VerificationMeta('nextOccurrenceTaskId');
  @override
  late final GeneratedColumn<String> nextOccurrenceTaskId =
      GeneratedColumn<String>(
        'next_occurrence_task_id',
        aliasedName,
        true,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('occurrence_number')) {
      context.handle(
        _occurrenceNumberMeta,
        occurrenceNumber.isAcceptableOrUnknown(
          data['occurrence_number']!,
          _occurrenceNumberMeta,
        ),
      );
    }
    if (data.containsKey('next_occurrence_task_id')) {
      context.handle(
        _nextOccurrenceTaskIdMeta,
        nextOccurrenceTaskId.isAcceptableOrUnknown(
          data['next_occurrence_task_id']!,
          _nextOccurrenceTaskIdMeta,
        ),
      );
    }
  ...
  Recurrence map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Recurrence(
      ...
      frequency: $RecurrencesTable.$converterfrequency.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
      ...
      occurrenceNumber: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}occurrence_number'],
      )!,
      nextOccurrenceTaskId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}next_occurrence_task_id'],
      ),
    );
  }
...
class Recurrence extends DataClass implements Insertable<Recurrence> {
  ...
  final String? nextOccurrenceTaskId;
  const Recurrence({
    required this.id,
    required this.taskId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['task_id'] = Variable<String>(taskId);
    {
      map['frequency'] = Variable<String>(
        $RecurrencesTable.$converterfrequency.toSql(frequency),
      );
    }
    ...
    map['occurrence_number'] = Variable<int>(occurrenceNumber);
    if (!nullToAbsent || nextOccurrenceTaskId != null) {
      map['next_occurrence_task_id'] = Variable<String>(nextOccurrenceTaskId);
    }
    return map;
  }
  ...
  RecurrencesCompanion toCompanion(bool nullToAbsent) {
    return RecurrencesCompanion(
      ...
      nextOccurrenceTaskId: nextOccurrenceTaskId == null && nullToAbsent
          ? const Value.absent()
          : Value(nextOccurrenceTaskId),
    );
  }
  ...
  factory Recurrence.fromJson(
    ...
    return Recurrence(
      id: serializer.fromJson<String>(json['id']),
      taskId: serializer.fromJson<String>(json['taskId']),
      frequency: $RecurrencesTable.$converterfrequency.fromJson(
      ...
      occurrenceNumber: serializer.fromJson<int>(json['occurrenceNumber']),
      nextOccurrenceTaskId: serializer.fromJson<String?>(
        json['nextOccurrenceTaskId'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'frequency': serializer.toJson<String>(
        $RecurrencesTable.$converterfrequency.toJson(frequency),
      ),
      'interval': serializer.toJson<int>(interval),
      'weekdays': serializer.toJson<String?>(weekdays),
      'endAt': serializer.toJson<DateTime?>(endAt),
      'maxOccurrences': serializer.toJson<int?>(maxOccurrences),
      'occurrenceNumber': serializer.toJson<int>(occurrenceNumber),
      'nextOccurrenceTaskId': serializer.toJson<String?>(nextOccurrenceTaskId),
    };
  }
  ...
  Recurrence copyWith({
    ...
    Value<String?> nextOccurrenceTaskId = const Value.absent(),
  }) => Recurrence(
    id: id ?? this.id,
    taskId: taskId ?? this.taskId,
    ...
    nextOccurrenceTaskId: nextOccurrenceTaskId.present
        ? nextOccurrenceTaskId.value
        : this.nextOccurrenceTaskId,
  );
  Recurrence copyWithCompanion(RecurrencesCompanion data) {
    return Recurrence(
      ...
      maxOccurrences: data.maxOccurrences.present
          ...
          : this.maxOccurrences,
      occurrenceNumber: data.occurrenceNumber.present
          ? data.occurrenceNumber.value
          : this.occurrenceNumber,
      nextOccurrenceTaskId: data.nextOccurrenceTaskId.present
          ? data.nextOccurrenceTaskId.value
          : this.nextOccurrenceTaskId,
    );
  }
  ...
  String toString() {
    return (StringBuffer('Recurrence(')
          ...
          ..write('occurrenceNumber: $occurrenceNumber, ')
          ..write('nextOccurrenceTaskId: $nextOccurrenceTaskId')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is Recurrence &&
          ...
          other.occurrenceNumber == this.occurrenceNumber &&
          other.nextOccurrenceTaskId == this.nextOccurrenceTaskId);
}
...
class RecurrencesCompanion extends UpdateCompanion<Recurrence> {
  ...
  final Value<int> occurrenceNumber;
  final Value<String?> nextOccurrenceTaskId;
  final Value<int> rowid;
  const RecurrencesCompanion({
    ...
    this.occurrenceNumber = const Value.absent(),
    this.nextOccurrenceTaskId = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<Recurrence> custom({
    ...
    Expression<int>? occurrenceNumber,
    Expression<String>? nextOccurrenceTaskId,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      ...
      if (occurrenceNumber != null) 'occurrence_number': occurrenceNumber,
      if (nextOccurrenceTaskId != null)
        'next_occurrence_task_id': nextOccurrenceTaskId,
      if (rowid != null) 'rowid': rowid,
    });
  }
  ...
  RecurrencesCompanion copyWith({
    ...
    Value<int>? occurrenceNumber,
    Value<String?>? nextOccurrenceTaskId,
    Value<int>? rowid,
  }) {
    return RecurrencesCompanion(
      id: id ?? this.id,
      ...
      occurrenceNumber: occurrenceNumber ?? this.occurrenceNumber,
      nextOccurrenceTaskId: nextOccurrenceTaskId ?? this.nextOccurrenceTaskId,
      rowid: rowid ?? this.rowid,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (frequency.present) {
      map['frequency'] = Variable<String>(
        $RecurrencesTable.$converterfrequency.toSql(frequency.value),
      );
    }
    if (interval.present) {
    ...
    if (occurrenceNumber.present) {
      map['occurrence_number'] = Variable<int>(occurrenceNumber.value);
    }
    if (nextOccurrenceTaskId.present) {
      map['next_occurrence_task_id'] = Variable<String>(
        nextOccurrenceTaskId.value,
      );
    }
    if (rowid.present) {
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('recurrences', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'tasks',
...
final class $$TasksTableReferences
  ...
  _recurrencesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.recurrences,
    aliasName: 'tasks__id__recurrences__task_id',
  );
...
final class $$RecurrencesTableReferences
  ...
  static $TasksTable _taskIdTable(_$AppDatabase db) =>
      db.tasks.createAlias('recurrences__task_id__tasks__id');
...
class $$RecurrencesTableFilterComposer
  ...
  ColumnFilters<int> get occurrenceNumber => $composableBuilder(
    column: $table.occurrenceNumber,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get nextOccurrenceTaskId => $composableBuilder(
    column: $table.nextOccurrenceTaskId,
    builder: (column) => ColumnFilters(column),
  );
...
class $$RecurrencesTableOrderingComposer
  ...
  ColumnOrderings<int> get occurrenceNumber => $composableBuilder(
    column: $table.occurrenceNumber,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get nextOccurrenceTaskId => $composableBuilder(
    column: $table.nextOccurrenceTaskId,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$RecurrencesTableAnnotationComposer
  ...
  GeneratedColumn<int> get occurrenceNumber => $composableBuilder(
    column: $table.occurrenceNumber,
    builder: (column) => column,
  );

  GeneratedColumn<String> get nextOccurrenceTaskId => $composableBuilder(
    column: $table.nextOccurrenceTaskId,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<DateTime?> endAt = const Value.absent(),
                Value<int?> maxOccurrences = const Value.absent(),
                Value<int> occurrenceNumber = const Value.absent(),
                Value<String?> nextOccurrenceTaskId = const Value.absent(),
                Value<int> rowid = const Value.absent(),
                ...
                nextOccurrenceTaskId: nextOccurrenceTaskId,
                rowid: rowid,
              ),
          createCompanionCallback:
              ({
